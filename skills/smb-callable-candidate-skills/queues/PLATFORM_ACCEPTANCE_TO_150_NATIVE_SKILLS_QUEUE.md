# Platform Acceptance To150 Native Skills Queue

更新日期: 2026-06-03

## Current Status

not_ready。To150 新增 50 个候选尚未完成许可证窗口 L1，也未完成 DeepAgents candidate smoke。

## Acceptance Gates

候选调用验收只验收 L1 放行且 smoke passed 的 mock/dry-run 边界；L3 候选验收只验收正式 L2 通过并生成 SKILL.md/skill.yaml 的 draft L3；稳交付扩容仍需另行通过平台正式验收。
