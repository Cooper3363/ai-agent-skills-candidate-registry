# native_marketing_ideas_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/marketing-ideas/SKILL.md
...
- roles: 老板、市场专员
- scenario: 用已有 SKILL.md 为中小微业务生成低成本营销创意
...
## 中文 smoke 用例
- 输入摘要: 社区宠物店希望下月做低成本拉新
- 预期输出字段: idea_list, priority, effort_notes, risk_notes, manual_review_required
