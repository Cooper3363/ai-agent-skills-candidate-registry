# native_sales_enablement_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/sales-enablement/SKILL.md
...
## 业务包、角色、场景
- business_package: 销售赋能包
- roles: 销售负责人、销售
- scenario: 用已有 SKILL.md 生成话术、异议处理、demo 脚本或一页纸草稿
...
## 中文 smoke 用例
- 输入摘要: 为门店 SaaS 销售准备价格异议处理话术
- 预期输出字段: talk_track, objection_responses, demo_notes, risk_notes, manual_review_required
