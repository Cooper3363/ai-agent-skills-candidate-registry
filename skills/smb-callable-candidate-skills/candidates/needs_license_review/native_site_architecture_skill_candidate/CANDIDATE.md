# native_site_architecture_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/site-architecture/SKILL.md
...
- roles: 市场负责人、网站运营
- scenario: 用已有 SKILL.md 规划官网栏目、导航和内链结构
...
## 中文 smoke 用例
- 输入摘要: 本地服务公司官网要重做栏目结构
- 预期输出字段: sitemap, navigation_notes, internal_linking_plan, risk_notes, manual_review_required
