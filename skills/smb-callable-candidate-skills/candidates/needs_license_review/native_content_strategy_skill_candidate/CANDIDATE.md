...
- source_url_or_path: C:/Users/Administrator/.codex/skills/content-strategy/SKILL.md
...
- roles: 内容运营、老板
- scenario: 用已有 SKILL.md 生成选题、主题集群和发布优先级
...
## 中文 smoke 用例
- 输入摘要: 本地财税服务公司想做一个月内容计划
- 预期输出字段: topic_clusters, editorial_priorities, channel_fit, risk_notes, manual_review_required
