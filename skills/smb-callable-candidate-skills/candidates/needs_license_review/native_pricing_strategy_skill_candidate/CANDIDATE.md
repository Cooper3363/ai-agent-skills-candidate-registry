...
- source_url_or_path: C:/Users/Administrator/.codex/skills/pricing/SKILL.md
...
## 业务包、角色、场景
- business_package: 经营策略包
- roles: 老板、销售负责人
- scenario: 用已有 SKILL.md 生成定价假设、套餐结构和风险提示
...
## 中文 smoke 用例
- 输入摘要: 门店管理 SaaS 想从单店收费改成按门店数收费
- 预期输出字段: pricing_options, value_metric_notes, risk_notes, open_questions, manual_review_required
