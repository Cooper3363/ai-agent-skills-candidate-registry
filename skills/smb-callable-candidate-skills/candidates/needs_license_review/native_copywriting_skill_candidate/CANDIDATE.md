# native_copywriting_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/copywriting/SKILL.md
...
- roles: 市场负责人、老板
- scenario: 用已有 SKILL.md 生成首页、落地页或服务页文案草稿
...
## 中文 smoke 用例
- 输入摘要: 给家政服务公司写落地页首屏文案
- 预期输出字段: headline_options, section_copy, cta_options, risk_notes, manual_review_required
