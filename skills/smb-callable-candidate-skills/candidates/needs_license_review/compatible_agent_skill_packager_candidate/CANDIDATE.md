# compatible_agent_skill_packager_candidate
...
- source_project: FrancyJGLisboa/agent-skill-creator
- source_url_or_path: https://github.com/FrancyJGLisboa/agent-skill-creator
...
## 业务包、角色、场景
- business_package: 平台运营包
- roles: AI.Skills 封装窗口、运营负责人
- scenario: 来自 agent-skill-creator 类仓库线索，用于把内部 SOP 转为 SKILL.md 草案
...
## 中文 smoke 用例
- 输入摘要: 给定售后 SOP 文档，输出 SKILL.md 封装检查清单
- 预期输出字段: skill_outline, manifest_gaps, permission_boundary, risk_notes, manual_review_required
