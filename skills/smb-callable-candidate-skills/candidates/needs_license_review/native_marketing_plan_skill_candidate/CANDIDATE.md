# native_marketing_plan_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/marketing-plan/SKILL.md
...
- roles: 老板、市场负责人
- scenario: 基于已有 SKILL.md 生成 30/60/90 天营销计划草案
...
## 中文 smoke 用例
- 输入摘要: 一家本地培训机构要做季度招生营销计划
- 预期输出字段: plan_summary, channel_plan, budget_notes, risk_notes, manual_review_required
