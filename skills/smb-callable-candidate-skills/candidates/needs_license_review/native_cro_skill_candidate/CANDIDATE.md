...
- source_url_or_path: C:/Users/Administrator/.codex/skills/cro/SKILL.md
...
- roles: 运营负责人、老板
- scenario: 基于已有 SKILL.md 审视表单、落地页和转化路径问题
...
## 中文 smoke 用例
- 输入摘要: 报名页转化低，给出现有页面文字和表单字段
- 预期输出字段: conversion_findings, friction_points, test_ideas, risk_notes, manual_review_required
