# native_visual_prompt_brief_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/visual_prompt_brief/SKILL.md
...
- roles: 市场专员、设计协作
- scenario: 基于已有 SKILL.md 生成视觉提示词 brief，不生成真实图片
...
## 中文 smoke 用例
- 输入摘要: 电商主图需要视觉提示词和负面提示词
- 预期输出字段: prompt_brief, asset_requirements, negative_prompts, risk_notes, generation_allowed
