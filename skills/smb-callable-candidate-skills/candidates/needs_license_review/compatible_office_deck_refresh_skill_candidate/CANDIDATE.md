# compatible_office_deck_refresh_skill_candidate
...
## 业务包、角色、场景
- business_package: 行政与销售赋能包
- roles: 销售运营、市场负责人、老板
- scenario: 来自 claude-office-skills 类 SKILL.md 仓库线索，用于销售/汇报 PPT 刷新 brief
...
## 中文 smoke 用例
- 输入摘要: 给定一页销售汇报内容，输出 PPT 结构与改版建议
- 预期输出字段: deck_outline, slide_improvements, visual_notes, risk_notes, manual_review_required
