# compatible_office_comps_summary_skill_candidate
...
- roles: 老板、财务负责人、销售负责人
- scenario: 来自 claude-office-skills 类 SKILL.md 仓库线索，用于 mock 表格中的竞品/可比项摘要
...
## 中文 smoke 用例
- 输入摘要: 给定 mock 竞品价格/功能表，输出摘要和缺口
- 预期输出字段: comparison_summary, evidence_notes, gap_flags, risk_notes, manual_review_required
