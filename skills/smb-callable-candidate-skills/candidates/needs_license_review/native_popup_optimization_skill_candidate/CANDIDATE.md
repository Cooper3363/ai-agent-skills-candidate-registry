# native_popup_optimization_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/popups/SKILL.md
...
## 业务包、角色、场景
- business_package: 营销与转化包
- roles: 运营、市场专员
- scenario: 基于已有 SKILL.md 设计弹窗文案、触发条件和合规提醒
...
## 中文 smoke 用例
- 输入摘要: 官网想加一个领取资料的退出弹窗
- 预期输出字段: popup_copy, trigger_rules, privacy_notes, risk_notes, manual_review_required
