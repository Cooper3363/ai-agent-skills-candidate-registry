# native_paywall_optimization_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/paywalls/SKILL.md
...
- roles: 产品运营、老板
- scenario: 用已有 SKILL.md 优化升级提示、套餐说明和转化风险
...
## 中文 smoke 用例
- 输入摘要: 免费用户达到次数限制，需要升级提示文案
- 预期输出字段: paywall_copy, plan_explanation, risk_notes, test_ideas, manual_review_required
