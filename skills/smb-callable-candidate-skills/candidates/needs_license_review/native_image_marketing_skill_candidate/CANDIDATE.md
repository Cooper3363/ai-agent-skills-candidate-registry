...
- source_url_or_path: C:/Users/Administrator/.codex/skills/image/SKILL.md
...
- roles: 市场专员、设计协作
- scenario: 基于已有 SKILL.md 生成图片创意 brief、构图和素材要求
...
## 中文 smoke 用例
- 输入摘要: 茶饮店新品海报，需要视觉 brief
- 预期输出字段: image_brief, asset_requirements, style_notes, risk_notes, generation_allowed
