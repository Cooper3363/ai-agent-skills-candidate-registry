# native_email_sequence_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/emails/SKILL.md
...
## 业务包、角色、场景
- business_package: 销售与客户运营包
- roles: 销售、客服运营、市场专员
- scenario: 用已有 SKILL.md 生成欢迎、唤醒或跟进邮件序列草稿
...
## 中文 smoke 用例
- 输入摘要: 新用户注册后 7 天内的欢迎邮件序列
- 预期输出字段: email_sequence, subject_options, timing_notes, compliance_notes, send_allowed
