...
- source_url_or_path: C:/Users/Administrator/.codex/skills/analytics/SKILL.md
...
## 业务包、角色、场景
- business_package: 经营报表包
- roles: 运营负责人、产品经理、老板
- scenario: 用已有 SKILL.md 生成事件埋点、转化漏斗和数据质量检查清单
...
## 中文 smoke 用例
- 输入摘要: 小程序下单流程需要设计转化漏斗指标
- 预期输出字段: tracking_plan, event_schema, qa_checks, privacy_notes, manual_review_required
