# native_referral_program_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/referrals/SKILL.md
...
- roles: 老板、客户成功、市场负责人
- scenario: 用已有 SKILL.md 设计老带新、推荐奖励和合规提示
...
## 中文 smoke 用例
- 输入摘要: 健身房想设计会员推荐好友活动
- 预期输出字段: referral_offer, eligibility_rules, message_draft, risk_notes, manual_review_required
