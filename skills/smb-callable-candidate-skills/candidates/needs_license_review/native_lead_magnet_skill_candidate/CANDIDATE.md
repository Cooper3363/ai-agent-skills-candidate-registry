# native_lead_magnet_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/lead-magnets/SKILL.md
...
## 业务包、角色、场景
- business_package: 营销获客包
- roles: 市场专员、老板
- scenario: 基于已有 SKILL.md 生成下载资料、清单或模板型 lead magnet 方案
...
## 中文 smoke 用例
- 输入摘要: 财税服务商想做一份小微企业报税检查清单
- 预期输出字段: lead_magnet_outline, capture_form_notes, delivery_notes, risk_notes, manual_review_required
