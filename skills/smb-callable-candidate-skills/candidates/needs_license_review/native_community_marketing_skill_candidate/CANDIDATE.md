# native_community_marketing_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/community-marketing/SKILL.md
...
## 业务包、角色、场景
- business_package: 营销与客户运营包
- roles: 社群运营、老板
- scenario: 基于已有 SKILL.md 设计社群增长、互动和转化活动
...
## 中文 smoke 用例
- 输入摘要: 母婴用品店想把老客户群做成月度活动社群
- 预期输出字段: community_plan, engagement_calendar, moderation_notes, risk_notes, manual_review_required
