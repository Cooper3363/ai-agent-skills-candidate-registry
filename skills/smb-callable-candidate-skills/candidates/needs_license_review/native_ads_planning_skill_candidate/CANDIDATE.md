# native_ads_planning_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/ads/SKILL.md
...
## 业务包、角色、场景
- business_package: 营销投放包
- roles: 市场负责人、老板、代运营
- scenario: 用已有 SKILL.md 做投放目标、预算、渠道和受众计划草稿
...
## 中文 smoke 用例
- 输入摘要: 本月预算 8000 元，希望做本地门店获客
- 预期输出字段: campaign_plan, budget_split, audience_notes, risk_notes, manual_review_required
