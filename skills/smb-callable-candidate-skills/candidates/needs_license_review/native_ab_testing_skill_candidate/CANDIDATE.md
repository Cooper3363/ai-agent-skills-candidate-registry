# native_ab_testing_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/ab-testing/SKILL.md
...
## 业务包、角色、场景
- business_package: 经营报表与增长实验包
- roles: 老板、运营负责人、增长负责人
- scenario: 用已有 SKILL.md 生成实验假设、指标口径、样本与风险提示
...
## 中文 smoke 用例
- 输入摘要: 活动页改版，希望比较新旧转化率
- 预期输出字段: experiment_hypothesis, metric_plan, sample_notes, risk_notes, manual_review_required
