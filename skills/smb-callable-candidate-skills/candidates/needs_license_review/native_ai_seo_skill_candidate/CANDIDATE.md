...
- source_url_or_path: C:/Users/Administrator/.codex/skills/ai-seo/SKILL.md
...
- roles: 市场负责人、内容运营
- scenario: 基于已有 SKILL.md 评估内容是否容易被 AI 搜索引用
...
## 中文 smoke 用例
- 输入摘要: 官网服务页文本，想知道是否适合 AI 搜索摘要
- 预期输出字段: visibility_findings, citation_opportunities, content_gaps, risk_notes, manual_review_required
