# native_co_marketing_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/co-marketing/SKILL.md
...
## 业务包、角色、场景
- business_package: 营销与合作包
- roles: 市场负责人、老板
- scenario: 基于已有 SKILL.md 生成联合营销伙伴筛选与活动方案
...
## 中文 smoke 用例
- 输入摘要: 本地瑜伽馆想和咖啡店做联合活动
- 预期输出字段: partner_criteria, campaign_ideas, mutual_value, risk_notes, manual_review_required
