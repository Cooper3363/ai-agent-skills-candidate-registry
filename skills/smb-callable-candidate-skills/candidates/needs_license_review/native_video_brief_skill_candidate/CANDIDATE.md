# native_video_brief_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/video/SKILL.md
...
## 业务包、角色、场景
- business_package: 营销视频包
- roles: 市场专员、短视频运营
- scenario: 基于已有 SKILL.md 生成短视频脚本、镜头和生成风险提示
...
## 中文 smoke 用例
- 输入摘要: 给美甲店做 30 秒短视频脚本 brief
- 预期输出字段: video_script, shot_list, asset_requirements, risk_notes, generation_allowed
