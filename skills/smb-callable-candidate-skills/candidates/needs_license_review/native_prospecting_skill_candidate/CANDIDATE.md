...
- source_url_or_path: C:/Users/Administrator/.codex/skills/prospecting/SKILL.md
...
- roles: 销售、BD、老板
- scenario: 基于已有 SKILL.md 在已提供线索列表中筛选 ICP 匹配度
...
## 中文 smoke 用例
- 输入摘要: 给定 10 家本地企业简介，筛选适合预约演示的潜客
- 预期输出字段: qualified_leads, fit_reasons, outreach_angle, risk_notes, manual_review_required
