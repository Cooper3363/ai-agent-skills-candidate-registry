# native_aso_listing_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/aso/SKILL.md
...
- roles: 产品运营、市场专员
- scenario: 基于已有 SKILL.md 优化应用市场标题、简介和关键词草稿
...
## 中文 smoke 用例
- 输入摘要: 预约排课小程序上架应用市场，需要优化简介
- 预期输出字段: listing_suggestions, keyword_notes, compliance_notes, missing_inputs, manual_review_required
