...
- source_url_or_path: C:/Users/Administrator/.codex/skills/launch/SKILL.md
...
## 业务包、角色、场景
- business_package: 营销与运营包
- roles: 老板、市场负责人、运营负责人
- scenario: 用已有 SKILL.md 生成新品、活动或功能上线 checklist
...
## 中文 smoke 用例
- 输入摘要: 门店会员卡新套餐下周上线，需要发布计划
- 预期输出字段: launch_checklist, message_plan, risk_notes, owner_due_dates, manual_review_required
