# native_onboarding_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/onboarding/SKILL.md
...
- roles: 客户成功、产品运营
- scenario: 基于已有 SKILL.md 设计新用户入门 checklist 和触达草稿
...
## 中文 smoke 用例
- 输入摘要: SaaS 新客户注册后不知道怎么完成首个设置
- 预期输出字段: onboarding_steps, activation_metrics, message_drafts, risk_notes, manual_review_required
