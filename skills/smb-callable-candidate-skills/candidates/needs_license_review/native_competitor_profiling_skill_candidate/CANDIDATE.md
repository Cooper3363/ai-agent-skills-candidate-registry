# native_competitor_profiling_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/competitor-profiling/SKILL.md
...
## 业务包、角色、场景
- business_package: 营销与销售情报包
- roles: 老板、市场负责人、销售
- scenario: 用已有 SKILL.md 在已提供资料基础上生成竞品画像
...
## 中文 smoke 用例
- 输入摘要: 给定两段竞品官网介绍文本，生成竞品画像
- 预期输出字段: competitor_profile, positioning_notes, sales_implications, source_notes, manual_review_required
