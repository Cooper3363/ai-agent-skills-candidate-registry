# native_competitor_comparison_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/competitors/SKILL.md
...
- roles: 市场负责人、销售运营
- scenario: 基于已有 SKILL.md 生成竞品对比页结构和合规提示
...
## 中文 smoke 用例
- 输入摘要: SaaS 产品要写“我们 vs 竞品”页面提纲
- 预期输出字段: comparison_outline, claim_checks, evidence_needed, risk_notes, manual_review_required
