...
- source_url_or_path: C:/Users/Administrator/.codex/skills/product-marketing/SKILL.md
...
## 业务包、角色、场景
- business_package: 营销策略包
- roles: 市场负责人、老板
- scenario: 基于已有 SKILL.md 建立产品定位、ICP 和价值主张文档
...
## 中文 smoke 用例
- 输入摘要: 给一个面向门店的排班工具整理定位上下文
- 预期输出字段: positioning, icp_notes, value_props, risk_notes, manual_review_required
