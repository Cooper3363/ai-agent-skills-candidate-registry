# native_copy_editing_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/copy-editing/SKILL.md
...
- roles: 市场专员、老板
- scenario: 基于已有 SKILL.md 对现有中文营销文案做修改和风险提示
...
## 中文 smoke 用例
- 输入摘要: 一段门店促销文案，要求更自然但不夸大
- 预期输出字段: edited_copy, change_notes, compliance_notes, risk_notes, manual_review_required
