# native_free_tool_planner_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/free-tools/SKILL.md
...
- roles: 老板、市场负责人
- scenario: 基于已有 SKILL.md 设计适合中小微企业的免费工具/计算器
...
## 中文 smoke 用例
- 输入摘要: 装修公司想做一个获客用报价估算器
- 预期输出字段: tool_concept, input_fields, lead_capture_notes, risk_notes, manual_review_required
