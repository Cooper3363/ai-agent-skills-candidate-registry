...
- source_url_or_path: C:/Users/Administrator/.codex/skills/directory-submissions/SKILL.md
...
- roles: 市场专员、老板
- scenario: 基于已有 SKILL.md 生成目录/平台提交资料清单和草稿
...
## 中文 smoke 用例
- 输入摘要: AI 工具准备提交到几个产品目录
- 预期输出字段: submission_checklist, profile_copy, directory_fit, risk_notes, submit_allowed
