# native_ad_creative_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/ad-creative/SKILL.md
...
- roles: 市场专员、老板、代运营
- scenario: 基于已有 SKILL.md 生成广告标题、主文案和多版本创意草稿
...
## 中文 smoke 用例
- 输入摘要: 门店周年庆，想要 5 组朋友圈和信息流广告创意
- 预期输出字段: creative_variants, channel_notes, compliance_notes, missing_inputs, manual_review_required
