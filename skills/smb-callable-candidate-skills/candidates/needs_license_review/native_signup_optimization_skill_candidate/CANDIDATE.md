# native_signup_optimization_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/signup/SKILL.md
...
## 业务包、角色、场景
- business_package: 经营增长包
- roles: 产品运营、老板
- scenario: 基于已有 SKILL.md 优化注册流程、表单字段和首步体验
...
## 中文 smoke 用例
- 输入摘要: SaaS 注册页字段太多，用户完成率低
- 预期输出字段: friction_points, field_recommendations, experiment_ideas, privacy_notes, manual_review_required
