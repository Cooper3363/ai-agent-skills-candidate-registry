# native_programmatic_seo_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/programmatic-seo/SKILL.md
...
- roles: 内容运营、市场负责人
- scenario: 用已有 SKILL.md 设计模板页、数据字段和风险边界
...
## 中文 smoke 用例
- 输入摘要: 本地服务公司想做城市+服务页面模板
- 预期输出字段: template_plan, data_fields, quality_checks, risk_notes, manual_review_required
