...
- source_url_or_path: C:/Users/Administrator/.codex/skills/revops/SKILL.md
...
## 业务包、角色、场景
- business_package: 销售运营包
- roles: 销售负责人、运营负责人
- scenario: 基于已有 SKILL.md 梳理线索阶段、交接规则和 CRM 字段建议
...
## 中文 smoke 用例
- 输入摘要: 销售线索从市场到销售常丢失，想整理流程
- 预期输出字段: lifecycle_stages, handoff_rules, crm_field_suggestions, risk_notes, manual_review_required
