# native_marketing_psychology_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/marketing-psychology/SKILL.md
...
## 业务包、角色、场景
- business_package: 营销内容包
- roles: 市场专员、老板
- scenario: 用已有 SKILL.md 给文案/活动补充行为科学视角和风险提示
...
## 中文 smoke 用例
- 输入摘要: 会员续费活动想更有吸引力但不能强迫
- 预期输出字段: psychology_levers, copy_suggestions, ethical_notes, risk_notes, manual_review_required
