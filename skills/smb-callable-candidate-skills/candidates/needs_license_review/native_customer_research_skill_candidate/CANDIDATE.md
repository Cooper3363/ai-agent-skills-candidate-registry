# native_customer_research_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/customer-research/SKILL.md
...
## 业务包、角色、场景
- business_package: 客服与经营洞察包
- roles: 产品经理、老板、客服运营
- scenario: 用已有 SKILL.md 汇总客户访谈、问卷或工单反馈
...
## 中文 smoke 用例
- 输入摘要: 5 条客户反馈文本，想提炼需求和痛点
- 预期输出字段: themes, customer_quotes_redacted, jobs_to_be_done, risk_notes, manual_review_required
