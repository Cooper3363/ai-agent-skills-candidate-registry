# native_social_content_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/social/SKILL.md
...
- roles: 新媒体运营、老板
- scenario: 用已有 SKILL.md 生成社媒内容草稿
...
## 中文 smoke 用例
- 输入摘要: 餐饮门店新品上架，想做 5 条社媒内容
- 预期输出字段: post_variants, channel_notes, compliance_notes, risk_notes, publish_allowed
