...
- source_url_or_path: C:/Users/Administrator/.codex/skills/geo-citation-agent/SKILL.md
...
- roles: 市场负责人、内容运营
- scenario: 用已有 SKILL.md 做品牌在 AI 搜索/答案中的引用机会审计
...
## 中文 smoke 用例
- 输入摘要: 给定品牌介绍和 3 段已提供搜索结果摘要
- 预期输出字段: citation_gaps, evidence_container_notes, content_actions, risk_notes, manual_review_required
