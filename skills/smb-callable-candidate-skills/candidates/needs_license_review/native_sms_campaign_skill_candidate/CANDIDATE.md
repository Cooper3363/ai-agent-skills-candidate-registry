...
- source_url_or_path: C:/Users/Administrator/.codex/skills/sms/SKILL.md
...
- roles: 运营、老板
- scenario: 基于已有 SKILL.md 生成短信活动、触达节奏和合规提示
...
## 中文 smoke 用例
- 输入摘要: 老客户 618 活动短信提醒草稿
- 预期输出字段: sms_drafts, timing_notes, compliance_notes, risk_notes, send_allowed
