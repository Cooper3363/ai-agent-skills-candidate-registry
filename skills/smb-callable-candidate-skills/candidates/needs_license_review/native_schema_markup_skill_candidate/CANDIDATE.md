# native_schema_markup_skill_candidate
...
- source_url_or_path: C:/Users/Administrator/.codex/skills/schema/SKILL.md
...
- roles: 网站运营、市场负责人
- scenario: 基于已有 SKILL.md 生成 schema.org/JSON-LD 建议草稿
...
## 中文 smoke 用例
- 输入摘要: 本地门店官网想增加 FAQ 和 LocalBusiness schema
- 预期输出字段: schema_recommendations, jsonld_draft, validation_notes, risk_notes, manual_review_required
