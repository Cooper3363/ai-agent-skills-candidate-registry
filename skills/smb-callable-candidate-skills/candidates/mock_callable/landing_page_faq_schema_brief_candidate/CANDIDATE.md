# landing_page_faq_schema_brief_candidate
...
## 中文 smoke 用例
- 输入摘要: 为课程页生成 FAQ 结构化 brief
- 预期输出字段: faq_items, schema_brief, source_notes, validation_risks
