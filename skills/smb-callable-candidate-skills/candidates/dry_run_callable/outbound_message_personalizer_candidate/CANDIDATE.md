# outbound_message_personalizer_candidate
...
## 中文 smoke 用例
- 输入摘要: 根据客户行业和上一轮沟通生成私信草稿
- 预期输出字段: message_draft, personalization_basis, risk_flags, external_action_blocked, send_allowed, write_allowed
