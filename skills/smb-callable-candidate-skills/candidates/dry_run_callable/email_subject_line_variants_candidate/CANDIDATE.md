# email_subject_line_variants_candidate
...
## 中文 smoke 用例
- 输入摘要: 会员日促销邮件生成 10 个标题
- 预期输出字段: subject_lines, rationale, spam_risk_flags, external_action_blocked, send_allowed, write_allowed
